...
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Linkbio');
    telegramDiv.addEventListener('click', function () {
        window.open('https://truongcongquy.bio.link/', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/truongcongquyinfo', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/Truong.Cong.Quy.info/', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Instagram');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/truong.cong.quy.info', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@truongcongquy.info', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.youtube.com/channel/UChGF99xBDDZMXpgWwusE4Kw', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Zalo');
    telegramDiv.addEventListener('click', function () {
        window.open('http://zaloapp.com/qr/p/v8p7bpq6zl8u', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var audio = new Audio('./audio/Give me a kisss.mp3');
...
welcomeText.textContent = "Welcome to profile of Trương Công Quý ✓";
